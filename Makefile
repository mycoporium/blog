...
SSH_HOST=blog.mycoporium.com
SSH_PORT=22
SSH_USER=root
SSH_TARGET_DIR=/var/www/blog.mycoporium.com/html
...
rsync_upload: publish
	rsync -e "ssh -p $(SSH_PORT)" -P -rvzc --include tags --cvs-exclude --chown=nginx:nginx --delete "$(OUTPUTDIR)"/ "$(SSH_USER)@$(SSH_HOST):$(SSH_TARGET_DIR)"
